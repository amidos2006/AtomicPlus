package AtomicPlus.GameEntity.GameMenu 
{
	 ...
	 * @author Amidos
	 */
	public class QuestionButtonEntity extends BaseEntity
	{	
		private var xText:Text;
		private var pressFunction:Function;
		private var touchPoints:Vector.<Point>;
		
		public function QuestionButtonEntity(xIn:int, yIn:int, pressFunction:Function) 
		{
			x = xIn;
			y = yIn;
			...
			xText = new Text("?", 0xFFFFFF, Text.LARGE_FONT * GraphicsLoader.ConversionRatio);
			xText.CenterOO();
